...
tables_to_join <- list(raw_to_SS_lookup,
                       suppressMessages(read_csv(
                         here(
                           'CASL-2 COMPS/RAW-TO-SS-LOOKUP-TABLES-SPSS/SPSS-LOOKUPS/ANT-Age-Norms-Raw-to-SS-from-SPSS.csv'
                         )
                       )),
                       calc_cols_df
)
...
R_SPSS_comps_table <- tables_to_join %>%
  ...
  select(
    rawscore, 
    # mo_36, a0300, calc_1, mo_39, a0330, calc_2, mo_42, a0360, calc_3, mo_45, a0390,
    # calc_4, mo_48, a0400, calc_5, mo_51, a0430, calc_6, mo_54, a0460, calc_7, mo_57, a0490,
    # calc_8, 
    mo_60, a0500, calc_1, mo_63, a0530, calc_2, mo_66, a0560, calc_3, mo_69, a0590,
    calc_4, mo_72, a0600, calc_5, mo_75, a0630, calc_6, mo_78, a0660, calc_7, mo_81,
    a0690, calc_8, mo_84, a0700, calc_9, mo_87, a0730, calc_10, mo_90, a0760, calc_11,
    mo_93, a0790, calc_12, mo_96, a0800, calc_13, mo_102, a0860, calc_14, mo_108, a0900,
    calc_15, mo_114, a0960, calc_16, mo_120, a1000, calc_17, mo_126, a1060, calc_18, mo_132,
    a1100, calc_19, mo_138, a1160, calc_20, mo_144, a1200, calc_21, mo_150, a1260, calc_22,
    mo_156, a1300, calc_23, mo_168, a1400, calc_24, mo_180, a1500, calc_25, mo_192, a1618,
    calc_26, mo_228, a1921, calc_27
  )
...
write_csv(R_SPSS_comps_table,
          here('CASL-2 COMPS/RAW-TO-SS-LOOKUP-TABLES-SPSS/COMPS/ANT-R-SPSS-SS-comps.csv'
          )
)
