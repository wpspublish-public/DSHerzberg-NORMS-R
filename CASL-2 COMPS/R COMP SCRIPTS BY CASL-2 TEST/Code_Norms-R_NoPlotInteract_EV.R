...
tables_to_join <- list(raw_to_SS_lookup,
                       suppressMessages(read_csv(
                         here(
                           'CASL-2 COMPS/RAW-TO-SS-LOOKUP-TABLES-SPSS/SPSS-LOOKUPS/EV-Age-Norms-Raw-to-SS-from-SPSS.csv'
                         )
                       )),
                       calc_cols_df
)
...
write_csv(R_SPSS_comps_table, 
          here('CASL-2 COMPS/RAW-TO-SS-LOOKUP-TABLES-SPSS/COMPS/EV-R-SPSS-SS-comps.csv'
          )
)
