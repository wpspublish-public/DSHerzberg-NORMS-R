...
SYNraw_by_agestrat <-
  suppressMessages(read_csv(here('INPUT FILES/SYNraw_STAND.csv')
  )) %>% group_by(agestrat)
...
mean_plot <- ggplot(data = SYN_tot_desc_agestrat, aes(group, mean)) +
  geom_point(
    col = "blue",
    fill = "blue",
    alpha = .5,
...
# ggplot(data = SYNraw_by_agestrat, aes(SYN_total)) +
#   geom_histogram(
#     binwidth = .2,
#     col = "red"
#   ) +
...
#   #   },
#   #   args = with(SYNraw_by_agestrat, c(mean = mean(SYN_total), sd = sd(SYN_total), n
#   #                     = length(SYN_total)))
#   # ) +
...
# ggplot(data = SYN_tot_desc_agestrat, aes(group, mean)) +
#   geom_point(
#     col = "blue",
#     fill = "blue",
#     alpha = .5,
...
# 
# ggplot(data = SYN_tot_desc_agestrat, aes(group, sd)) +
#   geom_point(
#     col = "red",
#     fill = "red",
#     alpha = .5,
